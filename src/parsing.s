...
#		memory will be an array of 2n 8-byte integers, with alternating y and x
#		coordinates.
#
...
.LparseData_coordinateLoop:
	...
	movw %ax, %r8w     # save x in r8w
	movq $10, %rsi     # '\n'
	call parseNumber   # increases rdi to point past-the-end of the number
	movw %ax, (%rdx)   # store y coordinate
	addq $2, %rdx      # point to the next place for a number
	movw %r8w, (%rdx)  # store x from r8w
	addq $2, %rdx      # point to the next place for a number
